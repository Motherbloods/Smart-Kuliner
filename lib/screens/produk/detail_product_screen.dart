                        ...
                        ? CarouselSlider(
                            ...
                            items: widget.product.imageUrls.map((imageUrl) {
                              return Container(
                                ...
                                color: Colors.white, // <-- background putih fix
                                alignment: Alignment.center,
                                child: Image.network(
                                  imageUrl,
                                  fit: BoxFit
                                      .contain, // <-- agar gambar tidak pecah
                                  width: double.infinity,
                                  height: double.infinity,
                                  loadingBuilder:
        ...
        child: SafeArea(
          child: Row(
            children: [
              ...
              // Add to Cart Button - Diperbaiki
              Expanded(
                child: SizedBox(
                  height: 48, // Set height yang pasti
